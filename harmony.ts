...
export const notes_in_key_flats = [
  ["C", "D", "E", "F", "G", "A", "B"],
  ["Db", "Eb", "F", "Gb", "Ab", "Bb", "C"],
  ["D", "E", "F#", "G", "A", "B", "C#"],
  ["Eb", "F", "G", "A", "Bb", "C", "D"],
...
export const notes_in_key_sharps = [
  ["C", "D", "E", "F", "G", "A", "B"],
  ["C#", "D#", "E#", "F#", "G#", "A#", "B#"],
  ["D", "E", "F#", "G", "A", "B", "C#"],
  ["Eb", "F", "G", "A", "Bb", "C", "D"],
...
// Note in key
export const note_in_key = function(tonality, degree) {
...
function full_range_arpeggio_triad(chord, index) {
  ...
  return io[chord][index % 3] + transpose;
}
...
function* full_range_arpeggio_sevenths(chord, index) {
  ...
  transpose = 12 * octaves;
  for (var i = 0; i < 4; i++) {
    yield io[chord][index % 4] + transpose;
  }
}
